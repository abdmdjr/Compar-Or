<template>
	<div class="relative overflow-hidden bg-gray-800">
		<div class="sm:block sm:absolute sm:inset-0 hidden">
			<svg
				class="lg:top-0 lg:mt-28 lg:mb-0 xl:transform-none xl:translate-x-0 absolute bottom-0 right-0 mb-48 text-gray-700 transform translate-x-1/2"
				width="364"
				height="384"
				viewBox="0 0 364 384"
				fill="none"
		...
		<div class="sm:pb-32 relative pt-6 pb-12">
			<nav
				class="sm:px-6 relative flex items-center justify-between max-w-screen-xl px-4 mx-auto"
			>
				<div class="flex items-center flex-1">
					<div class="md:w-auto flex items-center justify-between w-full">
						<a href="#" aria-label="Home">
							<img
								class="sm:h-10 w-auto h-8"
					...
					<div class="md:flex md:ml-10 hidden space-x-10">
						<a
							href="#"
							class="hover:text-gray-300 font-medium text-white transition duration-150 ease-in-out"
							>Product</a
						>
						<a
							href="#"
    ...
    -->
			<div
				class="md:hidden absolute inset-x-0 top-0 p-2 transition origin-top-right transform"
			>
					...
					<div class="lg:grid lg:grid-cols-12 lg:gap-8">
						...
						>
							<div>
								...
								>
									<span
										class="px-3 py-0.5 text-white text-xs font-semibold leading-5 uppercase tracking-wide bg-teal-500 rounded-full"
										>We're hiring</span
									>
									<span class="ml-4 text-sm leading-5"
								...
								<p
									class="sm:mt-5 sm:text-xl lg:text-lg xl:text-xl mt-3 text-base text-gray-300"
								>
								...
								<p
									class="sm:mt-10 mt-8 text-sm font-semibold tracking-wide text-white uppercase"
								>
									Used by
								</p>
						...
						<div class="sm:mt-16 lg:mt-0 lg:col-span-6 mt-12">
							<div
								class="sm:max-w-md sm:w-full sm:mx-auto sm:rounded-lg sm:overflow-hidden bg-white"
							>
								...
								<div
									class="bg-gray-50 sm:px-10 px-4 py-6 border-t-2 border-gray-200"
								>
